...
export const en = {
    ...
    'page.body.landing.marketInfo.title.text1': 'Welcome to Tradex.',
    ...
    'page.body.landing.register.item.text': 'Tradex offers an intuitive interface with real time orderbooks, charting tools, trade history, and a simple order process so you can trade from day one.',
    'page.body.landing.register.item.button': 'register',

    'page.body.landing.features.title': 'Tradex platform features',
    ...
    'page.body.landing.features.features.item1.text': 'Tradex offers the most liquid order book in the world, allowing users to easily exchange Bitcoin, Ethereum, EOS, Litecoin, Ripple, NEO and many other digital assets with minimal slippage.',
    'page.body.landing.features.features.item2.text': 'Tradex offers a suite of order types to give traders the tools they need for every scenario. Discover more about our most advanced Algorithmic orders types.',
    ...
    'page.body.landing.tradeOnTheGo.item.text3': 'All the power of Tradex cryptocurrency exchange, in the palm of your hand.',
    ...
    'page.body.landing.footer.rights': 'Tradex © All rights reserved.',
